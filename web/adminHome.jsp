                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewResult.jsp" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">DSA</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">OS</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">CA</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">DBMS</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">ALGO</label>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group row">
                                    <label for="permanent_address" class="col-md-4 col-form-label text-md-right">CN</label>
                                    <div class="col-md-6">
...
<section>
  ...
  <div class="tbl-content">
   ...
   <% }}
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact SCSIT.
Designed & Developed by  CO-ORDINATOR</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ SCSIT:: 2015-2020</h5></center> 
  <hr class="new1">
<br>
</body>
</html>